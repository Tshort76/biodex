...
import dev.tlong.animaldex.data.catalogue.CatalogueReconciler.ExistingSpecies
import dev.tlong.animaldex.data.catalogue.CatalogueReconciler.ImportPlan
...
fun curatedSpecies(
    ...
    taxClass = dev.tlong.animaldex.domain.TaxClass.BIRD,
