...
For animals there is no identifier in the app, and rather than pick one badly, BioDex accepts the answer from wherever you got it. Identify the bird in **Merlin**, which is free, offline and made by the Cornell Lab, or in Lens, or read it off a smart feeder's notification — then Share → BioDex, and Register opens with the photo attached and the name filled in. The point is that nothing has to be memorised between the two apps. A shared photo is copied rather than linked, because Android's share sheet hands over permission that expires with the task.
